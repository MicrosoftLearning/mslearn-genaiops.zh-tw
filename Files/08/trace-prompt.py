...
# This will print the trace data to the console
...
with tracer.start_as_current_span("generate_completion") as span:
    try:
        ...
        response = chat_client.complete(
            model=model_name,
            messages=[
                SystemMessage("You are an AI assistant that acts as a travel guide. Respond with 1 sentence."),
                UserMessage(content=(
        ...
        # Add response attributes to the span for tracing
    ...
    # If an error occurs, set the span status to ERROR and record the exception
